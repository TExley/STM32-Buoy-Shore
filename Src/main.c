...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	nRF24_SetRFChannel(24); // set RF channel to 2490MHz
	...
	nRF24_SetRXPipe(nRF24_PIPE1, nRF24_AA_ON, 3); // enable RX pipe#1 with Auto-ACK: enabled, payload length: 10 bytes
